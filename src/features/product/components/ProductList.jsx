...
import { ITEMS_PER_PAGE } from "../../../app/contstants";
...
export default function ProductList() {
  ...
  const catogries = useSelector(selectCategories);
            ...
            {Array.from({ length: totalPages }).map(
              (el, index) => (
                <div
                  ...
                  aria-current="page"
                  className={`relative z-10 cursor-pointer inline-flex text-black items-center ${
                    index + 1 === page
